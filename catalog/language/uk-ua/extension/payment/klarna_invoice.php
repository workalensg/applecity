...
$_['text_terms_fee']			= '<span id="klarna_invoice_toc"></span> (+%s)<script type="text/javascript">var terms = new Klarna.Terms.Invoice({el: &#39klarna_invoice_toc&#39, eid: &#39%s&#39, country: &#39%s&#39, charge: %s});</script>';
$_['text_terms_no_fee']			= '<span id="klarna_invoice_toc"></span><script type="text/javascript">var terms = new Klarna.Terms.Invoice({el: &#39klarna_invoice_toc&#39, eid: &#39%s&#39, country: &#39%s&#39});</script>';
...
$_['text_month']				= 'Месяц';
$_['text_day']					= 'День';
$_['text_comment']				= 'Klarna&#39s Invoice ID: %s. ' . "\n" . '%s/%s: %.4f';
...
$_['help_company']				= 'Please enter your Company&#39s registration number';

// Error
$_['error_deu_terms']			= 'You must agree to Klarna&#39s privacy policy (Datenschutz)';
