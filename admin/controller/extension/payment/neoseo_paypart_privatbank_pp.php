...
class ControllerExtensionPaymentNeoseoPaypartPrivatbankPp extends NeoSeoController
{
	...
	public function __construct($registry)
	{
		...
		/* Remove _module_code */
		$this->_modulePostfix = "_pp"; // Постфикс для разных типов модуля, поэтому переходим на испольлзование $this->_moduleSysName()
	...
	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->model_extension_payment_neoseo_paypart_privatbank_pp->setModuleStatus("payment_" . $this->request->post[$this->_moduleSysName() . $this->_modulePostfix . "_status"]);
