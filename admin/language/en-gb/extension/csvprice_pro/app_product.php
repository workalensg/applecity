...
$_['text_success_auto_import'] = 'Data import has been completed!<br /><br />Processed <b>%s</b> strings totally!<br /><br /> Updated: <b>%s</b><br />Added: <b>%s</b><br />Deleted: <b>%s</b><br />Missing: <b>%s</b><br /><br />Execution time: %s sec / Memory usage: %s';
$_['text_related_2directional'] = 'Two-directional';
$_['text_related_1directional'] = 'One-directional';
$_['text_macro_field_type'] = 'If the selected type HTML, then special characters will be converted to HTML-entities.';
...
$_['tab_fields'] = 'Setup field mappings';
$_['tab_export'] = 'Export';
$_['tab_import'] = 'Import';
$_['tab_macros'] = 'Macros';
...
$_['entry_csv_number'] = 'Column number in a CSV file';
$_['entry_find_by_column_number'] = 'Search by column number';
...
$_['entry_import_calc_mode'] = 'Price calculation';
...
prop_descr[14]="<p><b>Fill parent categories</b></p><p>Set displaying product in all parent categories, works only for the _CATEGORY_ field.</p>";
...
prop_descr[35]="Search for matching fields by column numbers for a file without the first line as a header (for import) <br> or exclude the first line as a header from the file (for export)"; 
';
