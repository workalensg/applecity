...
$_['text_webmoney_wmb']       = '<a style="cursor: pointer;" onclick="window.open(&#39https://webmoney.ru&#39);"><img src="view/image/payment/webmoney_wmb.gif" alt="Webmoney" title="Webmoney" style="border: 1px solid #EEEEEE;" height="25px" /></a>';
