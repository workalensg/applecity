...
$_['help_order_status_pending']     = 'The order status after the customer&#39s order has been placed.';
$_['help_order_status_canceled']    = 'The order status after the customer&#39s order is canceled.';
$_['help_order_status_processing']  = 'The order status after the customer&#39s order is paid.';
