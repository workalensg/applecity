...
$_['text_webmoney_wmu']       = '<a style="cursor: pointer;" onclick="window.open(&#39https://webmoney.ru&#39);"><img src="view/image/payment/webmoney_wmu.gif" alt="Webmoney" title="Webmoney" style="border: 1px solid #EEEEEE;" height="25px" /></a>';
