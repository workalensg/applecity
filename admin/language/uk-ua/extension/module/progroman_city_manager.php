...
$_['entry_bind_subdomain'] = 'Прив&#39язати місто до піддомену / URL<span class="help" data-toggle="tooltip" title="Місто залежить від піддомену і тільки, якщо його немає в списку, визначається за IP"></span>';
